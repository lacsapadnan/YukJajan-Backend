            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tbody>
                        @forelse ($transaction as $item)
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    <a href="{{ route('transaction.show', $item->id) }}" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded">View</a>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="border text-center p-6"> Data tidak ditemukan</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
