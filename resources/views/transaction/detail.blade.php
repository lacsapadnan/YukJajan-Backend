    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8"> 
            <div class="w-full rounded overflow-hidden shadow-lg px-6 py-6 bg-white">
                ...
                <div class="w-full md:5/6 px-4 mb-4 md:mb-0">
                        ...
                        <div class="flex flex-wrap mb-3">
                            ...
                            <div class="w-1/6">
                                ...
                                <div class="text-xl font-bold">{{ number_format($item->user->houseNumber) }}</div>
                            </div>
                            <div class="w-1/6">
                                <div class="text-sm">Phone</div>
                                <div class="text-xl font-bold">{{ number_format($item->user->phoneNumber) }}</div>
                            </div>
                        </div>
                        <div class="flex flex-wrap mb-3">
                            <div class="w-5/6">
                            ...
                            <div class="w-1/6">
                                ...
                                <a href="{{ route('trasaction.changeStatus', ['id' => $item->id, 'status'=> 'ON_DELIVERY']) }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold px-2 rounded block text-center w-full mb-1">On Delivery</a>
                                <a href="{{ route('trasaction.changeStatus', ['id' => $item->id, 'status'=> 'DELIVERED']) }}" class="bg-green-500 hover:bg-green-700 text-white font-bold px-2 rounded block text-center w-full mb-1">Delivered</a>
                                <a href="{{ route('trasaction.changeStatus', ['id' => $item->id, 'status'=> 'CANCELLED']) }}" class="bg-red-500 hover:bg-red-700 text-white font-bold px-2 rounded block text-center w-full mb-1">Cancelled</a>
                            </div>
                        </div>
                    </div>
            </div>
